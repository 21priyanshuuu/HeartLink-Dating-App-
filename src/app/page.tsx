...
export default async function Home() {
  ...
  return (
    ...
    <BackgroundLines className="flex items-center justify-center w-full flex-col px-4 bg-openmai-bg">
      <h2 className="bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-200 to-neutral-400 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
